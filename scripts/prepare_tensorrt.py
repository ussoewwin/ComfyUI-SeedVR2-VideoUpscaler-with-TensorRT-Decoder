"""Export and build the four fixed-shape TensorRT RTX VAE engines for ComfyUI SeedVR2."""
...
if __name__ == "__main__":
    try:
        ...
        print(f"TensorRT preparation failed with exit code {exc.returncode}.", file=sys.stderr)
