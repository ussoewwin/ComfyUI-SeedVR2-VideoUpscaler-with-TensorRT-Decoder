...
- **Technical Details:** See [v1.3 Release Notes](https://github.com/ussoewwin/ComfyUI-SeedVR2_VideoUpscaler/releases/tag/v1.3) for complete explanation
...
- **Technical Details:** See [v1.2 Release Notes](https://github.com/ussoewwin/ComfyUI-SeedVR2_VideoUpscaler/releases/tag/v1.2) for complete explanation
...
- **Technical Details:** See [v1.1 Release Notes](https://github.com/ussoewwin/ComfyUI-SeedVR2_VideoUpscaler/releases/tag/v1.1) for complete explanation
...
- **Technical Details:** See [v1.0 Release Notes](https://github.com/ussoewwin/ComfyUI-SeedVR2_VideoUpscaler/releases/tag/v1.0) for complete explanation
