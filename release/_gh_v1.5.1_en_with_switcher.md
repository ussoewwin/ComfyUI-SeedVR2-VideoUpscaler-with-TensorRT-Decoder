...
| **64-bit Seed Support** | `src/interfaces/video_upscaler.py`<br>`src/common/seed.py` | Expanded seed widget range to full 64-bit (`0..0xffffffffffffffff`) matching ComfyUI core nodes (KSampler). Removed obsolete NumPy random seed dependency and applied 64-bit mask to prevent PyTorch seed overflow ([PR #635](https://github.com/numz/ComfyUI-SeedVR2_VideoUpscaler/pull/635)). |
